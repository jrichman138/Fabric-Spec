...
**Tags:** `workwear` `structure` `pants` `pocket`

**Needle**
- Primary: Schmetz Jeans 90/14 or 100/16
- Alternative: Schmetz Universal 100/16
...
- Stitch width: 0 (straight stitch)
- Tension: 4–5
- Presser foot: Walking foot strongly recommended on heavier weights
...
**Detail**
Hemp canvas is a natural-fiber alternative to cotton duck — comparable weight and weave but with longer, stronger fibers that give it superior abrasion resistance per gram. It's used for aprons, workwear pants, tool rolls, market bags, and any application where you'd otherwise reach for duck but want the natural breathability and patina of hemp. Pure hemp is rare in retail; hemp-cotton blends (typically 55/45 or 70/30 hemp/cotton) are more common and easier to source. The sewing approach is essentially the same as duck canvas — heavy needle, strong polyester thread, walking foot for multi-layer work. The main differences are pronounced shrinkage on the first wash and a very stiff initial hand, both of which resolve after the first laundering. For workwear that's meant to mold to the wearer over time, hemp is one of the most rewarding natural fibers.
...
**Needle**
- Primary: Schmetz Jeans/Denim 90/14
- Alternative: Schmetz Jeans/Denim 100/16 for 14oz+ weights
...
**Machine Settings**
- Stitch length: 2.5–3.0 mm for seams; 3.0–3.5 mm for topstitching
- Stitch width: 0 (straight stitch)
...
**Detail**
Denim is a warp-faced cotton twill — the diagonal weave that gives jeans their characteristic look and resilience. 10–12oz is the most common weight for jeans and jean jackets; 14oz+ enters raw and selvedge territory where the 4452 starts to work hard. The signature challenge is the seam intersection at the inseam, where four to six layers stack up. A hump jumper is the simplest and most effective fix — it levels the foot so the feed dogs stay engaged and the needle isn't deflecting off the layer step. Mara 30 in a contrasting color is the classic topstitching choice; it requires a heavier needle and slightly higher tension to set properly into the dense weave. For raw denim, skip pre-washing if you want shrink-to-fit results, but expect 5–10% shrinkage on the first wash. Pre-washed denim sews more predictably and is the better starting point for a first pair of jeans.

---

### Cotton Sateen

**Tags:** `pants` `workwear` `shirt`

**Needle**
- Primary: Schmetz Microtex Sharp 80/12
...
**Detail**
Cotton sateen is a smooth, slightly lustrous weave used for British military trousers (the 107 pattern, originally Royal Marines), traditional chinos, and dressier workwear pants. The weave is similar to satin but executed in cotton — long warp floats give it a soft sheen on the face while keeping a matte cotton back. It's denser than twill and shows stitches more prominently, which means clean tension and a fresh needle matter more than usual. Microtex needles are ideal: the sharp point pierces the tight weave without deflecting or pushing yarns aside. For pants, flat-felled or French seams add durability and a tailored finish; for shirts, press seams open. The sheen direction is subtle but real — cut all pieces with the same orientation and the finished garment will have consistent color and reflectivity.

---

### Cotton Poplin

**Tags:** `shirt` `lining` `pocket`

**Needle**
- Primary: Schmetz Microtex Sharp 70/10 or 80/12
- Alternative: Schmetz Universal 80/12
...
**Detail**
Cotton poplin is a tight plain-weave cotton with a slight ribbed texture (the weft is heavier than the warp). It's the workhorse shirting fabric — casual button-ups, dress shirts, light pants, and pocket bags. Distinct from this catalog's Polyester Broadcloth entry, cotton poplin behaves more predictably under the iron, presses crisper, and frays more aggressively. The fine plain weave benefits from a Microtex needle: the sharp point pushes through cleanly without leaving visible perforations, which matters on shirts where every needle hole shows. Use a shorter stitch (2.0 mm) for collar and cuff topstitching to get crisp curves, and a slightly longer stitch (2.5 mm) for side seams. Press seams open on dressier shirts; press to one side and topstitch on casual workshirts.

---

### Chambray

**Tags:** `workwear` `shirt` `shell` `lining` `pocket`

**Needle**
- Primary: Schmetz Universal 80/12
- Alternative: Schmetz Microtex Sharp 80/12
...
**Detail**
Chambray is a plain-weave cotton with a colored warp and white weft — the result looks like lightweight denim but with the hand and drape of a fine shirting cotton. It's the canonical American workshirt fabric, used everywhere from chore coats to Eisenhower jackets to modern casual button-ups. Despite the visual similarity to denim, the sewing approach is closer to poplin: universal or Microtex needle, standard tension, and careful edge finishing because the plain weave frays readily. For workshirt construction, flat-felled seams give the authentic look and add durability. Yoke and patch pocket topstitching with a contrasting thread is what makes a chambray shirt read as workwear rather than dress.

---

### Flannel

**Tags:** `workwear` `shirt` `midlayer` `lining`
...
- Stitch width: 0 (straight stitch); 4.0 mm zigzag for edge finishing
- Tension: 4
- Presser foot: Walking foot helps with thicker flannels and lined construction
...
**Detail**
Flannel is a brushed cotton in either twill or plain weave — the brushed face gives it the soft, warm hand that makes flannel shirts a workwear staple. The brushing process raises a short nap on one or both sides, which traps air and adds warmth without much added weight. The main sewing considerations are shrinkage (often 5–10% on first wash, sometimes more) and plaid matching, which is the difference between a flannel shirt that looks store-bought and one that looks homemade. Cut single-layer for plaid matching and use plenty of clips to align repeats at seam lines. The nap can hide pins and cause slight feed inconsistency — a walking foot helps for heavier flannels and especially when sewing flannel as a winter lining for jackets or pants.
...
**Tags:** `workwear` `shirt` `pants` `pocket`
...
**Detail**
50/50 NyCo poplin is the authentic summer-weight uniform fabric — the cloth used for original BDUs, M65 field shirts, summer-weight cargo pants, and Vietnam-era jungle utilities. It's distinct from this catalog's Nyco Ripstop entry: poplin is a plain weave (no ripstop grid), tighter and smoother, with more drape and better next-to-skin feel. The nylon content adds tear strength and abrasion resistance while the cotton keeps the fabric breathable and presentable. Sewing-wise, it behaves like a high-quality cotton/poly shirt fabric — straightforward needle and thread choices, predictable feed, no special tricks required. The standout construction decision is the flat-felled seam on inseams and side seams, which is the defining feature of mil-spec uniform construction and adds real durability beyond the visual appeal. For accurate field shirts and BDUs, build out the full set of bar tacks and reinforced stress points; the original specs called for them and the fabric rewards the effort.
...
**Tags:** `tshirt` `base-layer` `midlayer`

**Needle**
- Primary: Schmetz Jersey/Ball Point 80/12
- Alternative: Schmetz Stretch 75/11
...
**Detail**
Cotton jersey is the foundational t-shirt fabric — a single knit with a smooth face and a slightly textured back. Weights run from 140 gsm (light, drapey summer tees) to 180 gsm (standard t-shirt weight) to 220+ gsm (heavier, structured tees). The signature challenge for the home sewer is that the cut edge curls aggressively, especially on lighter weights — let it curl, work with it, and don't try to press it flat before sewing. The other key shift from woven fabric is the stitch: a straight stitch on a stretch seam will simply break the first time the seam is loaded. Use a narrow zigzag (2.0 mm wide × 2.5 mm long) or a lightning bolt stitch if the 4452 has one. For hems, a twin needle delivers parallel topstitching on the face with a zigzag underneath, mimicking the flatlock or coverstitch look of commercial t-shirts.
...
**Needle**
- Primary: Schmetz Stretch 75/11
- Alternative: Schmetz Jersey 75/11
...
**Detail**
Cotton/spandex jersey (typically 92/8 or 95/5 cotton/spandex by composition) is the modern stretch t-shirt fabric. The spandex content gives the garment recovery — it returns to shape after being stretched, where pure cotton jersey will gradually bag out. This is the right fabric for fitted tees, leggings, and athletic-leaning casual wear. The sewing approach is similar to cotton jersey with three meaningful adjustments: a Stretch needle is non-negotiable (a Universal or even Ballpoint will skip stitches on the spandex), heat must be kept low to avoid degrading the spandex, and seam stabilization at the neckline and shoulders becomes more important because the fabric stretches in all directions, not just across the grain. Hem with a twin needle for a clean, recoverable finish; topstitching with regular thread will pop unless you switch to a stretch-thread bobbin or use a zigzag underneath.

---

### Cotton Rib Knit

**Tags:** `tshirt` `midlayer` `trim`
...
**Quick Tips**
- Cut rib trim shorter than the opening it's attaching to — typically 80–90% for necklines, 90% for cuffs — so it stretches to fit and pulls in cleanly
...
**Detail**
Cotton rib knit is the companion fabric to every t-shirt, sweatshirt, and knit garment — used for cuffs, collars, neckbands, hems, and occasionally as a ribbed-body garment in its own right. The defining property is bidirectional elasticity that recovers strongly, which is exactly what's needed for a neckband that needs to stretch over a head and snap back to fit close. The most important sewing skill is sizing the rib correctly: too long and the trim flops, too short and it puckers the body fabric. Quartering is the proven technique — mark equal quarters on both the rib and the body opening, match them, and stretch the rib evenly to fit between marks. 1×1 rib is the standard for t-shirt necklines; 2×2 rib is heavier and shows up on sweatshirt cuffs and hems. For most home sewing, buy rib trim that matches the body fabric in fiber content so it shrinks and ages the same way.

---

### French Terry

**Tags:** `midlayer` `loungewear`

**Needle**
- Primary: Schmetz Jersey 80/12
- Alternative: Schmetz Jersey 90/14 for heavier weights
...
**Machine Settings**
- Stitch length: 2.5–3.0 mm
- Stitch width: 2.5–3.5 mm zigzag for stretch seams; 0 for stable seams (yokes, waistbands)
- Tension: 3.5
...
**Detail**
French terry is a knit fabric with a smooth jersey face and a looped back — lighter and less brushed than sweatshirt fleece, with a distinctive textured back that gives it good moisture-wicking and warmth-to-weight. Typical weights run 220–280 gsm, putting it in sweatshirt and lightweight hoodie territory. It's a forgiving knit to sew compared to fine jersey: the texture and weight give it more body, less curl at the edges, and easier feed. The main considerations are loop direction (loops always face inward in finished garments) and stitch choice (zigzag or lightning stitch for stretch seams, straight stitch only on stable seams like yokes). For a sweatshirt build, the construction sequence is shoulders → neckband → sleeves in flat → side seams from cuff to hem in one pass.

---

### Cotton Sweatshirt Fleece

**Tags:** `midlayer` `insulation` `loungewear`

**Needle**
- Primary: Schmetz Jersey 90/14
- Alternative: Schmetz Stretch 90/14
...
**Machine Settings**
- Stitch length: 2.5–3.0 mm
- Stitch width: 3.0–4.0 mm zigzag for stretch seams
- Tension: 3.5–4
- Presser foot: Walking foot strongly recommended
...
**Detail**
Cotton sweatshirt fleece is the classic hoodie and sweatpants fabric — a heavier knit (typically 280–380 gsm) with a brushed-back face that traps air and reads as soft against the skin. It's distinct from this catalog's Polartec Grid Fleece entry: cotton fleece is heavier, less technical, less moisture-wicking, but warmer per gram and more comfortable for casual wear. The brushed nap is the main sewing consideration — it sheds lint heavily into the feed dogs and bobbin area, slows the foot's glide across the surface, and adds bulk at every seam intersection. A walking foot solves the glide problem; trimming seam allowances and pressing seams flat solves the bulk problem; vacuuming or brushing the bobbin area between projects solves the lint problem. For hoodie construction, channel-stitching the hood interlining adds shape and prevents the hood from collapsing flat behind the wearer's head.
...
**Needle**
- Primary: Schmetz Jersey 70/10 or 75/11
- Alternative: Schmetz Stretch 75/11
...
**Detail**
Merino wool jersey is the premium performance base-layer fabric: warm when cold, cool when warm, naturally odor-resistant, and quiet against the skin. Weights run from 150 gsm (ultralight summer travel tees) to 200 gsm (standard base layer) to 260+ gsm (heavier interlock merino for cold-weather layering). The defining sewing challenge is that merino is more delicate than cotton or synthetic jersey — needle holes show, the fabric distorts permanently if pulled while sewing, and the fine yarns can snag on standard needles. A smaller-than-usual Jersey needle (70/10 or 75/11) and fine thread (Mara 120) minimize the visible footprint of every stitch. Lightning stitches or narrow zigzag are required for stretch seams, the same as cotton jersey. The fabric rewards careful work: a well-sewn merino tee can last years of regular wear, while a rushed one will show puckered seams and broken yarns within a few washes.
